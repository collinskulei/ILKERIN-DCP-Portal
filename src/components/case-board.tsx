        ...
        return (
          ...
          >
            ...
            <div className="space-y-2">
              ...
              {columnRows.length === 0 && (
                <p className="px-1 text-xs text-zinc-400">No clients here.</p>
              )}
            </div>
          </div>
        );
            ...
            <tr key={row.application_id}>
              ...
              <td className="px-4 py-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-zinc-500">{row.completion_pct}%</span>
                </div>
              </td>
              <td className="px-4 py-3 text-zinc-600">{row.case_manager_name ?? "Unassigned"}</td>
              <td className="px-4 py-3">
                <NotificationBadges row={row} />
              </td>
            </tr>
